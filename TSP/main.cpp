...
Subproject 3 - Optimal Solution to TSP using Branch and Bound
...
<program name> [Number of cities] [RNG seed]
...
int main(int argc, char **argv) {
    ...
    if ( argc == 1 ) {
		std::cout << "Using default parameters. Setting cities to 4 and using random RNG seed.\n"
		             ...
		             "Usage: \n\t" << argv[0] << " [Number of cities] [RNG seed]\n\n";
	}
    if ( argc >= 4 ) {
        std::cerr << "Incorrect number of parameters. 0 or 1 or 2 expected. \n"
		             "Usage: \n\t" << argv[0] << " [Number of cities] [RNG seed]\n\n";
